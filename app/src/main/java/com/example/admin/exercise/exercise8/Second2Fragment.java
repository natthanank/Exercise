...
import com.example.admin.exercise.exercise6.BMI;
...
public class Second2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_second5, container, false);
        BMI bmi = getArguments().getParcelable("bmi");
        nextBtn = rootView.findViewById(R.id.nextFragment);
        backBtn = rootView.findViewById(R.id.backFragment);
