...
public class TabFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.navigation_tab1:
                        ...
                        transaction.replace(R.id.fragment_tab_frame, firstFragment);
                        transaction.commit();
                        break;
                    case R.id.navigation_tab2:
                        SecondFragment secondFragment = SecondFragment.newInstance(null,null);
                        transaction.replace(R.id.fragment_tab_frame, secondFragment);
                        transaction.commit();
                        break;
                    case R.id.navigation_tab3:
                        ThirdFragment thirdFragment = ThirdFragment.newInstance(null,null);
                        transaction.replace(R.id.fragment_tab_frame, thirdFragment);
                        transaction.commit();
                        break;
                    default:
        ...
        bottomNavigationView.setSelectedItemId(R.id.navigation_tab1);
        return rootView;
    }
