    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean createSuccessful = database.create(user);

                if (createSuccessful) {
                    Toast.makeText(view.getContext(), "Craete Successful", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(view.getContext(), "Please Enter the correct information", Toast.LENGTH_SHORT).show();
                }

                ListFragment.ACTION = Database.CRAETE;
